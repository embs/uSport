...
function tbAdaptor(){
	...
	if (docWidth>=1600){
		$("div[tb-g-1600]").each(function(index){
			$(this).removeClass("span1 span2 span3 span4 span5 span6 span7 span8 span9 span10 span11 span12 hide").addClass($(this).attr("tb-g-1600"));
		});
	}else if (docWidth>=1400){
		$("div[tb-g-1400]").each(function(index){
			$(this).removeClass("span1 span2 span3 span4 span5 span6 span7 span8 span9 span10 span11 span12 hide").addClass($(this).attr("tb-g-1400"));
		});
